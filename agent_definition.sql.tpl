-- This file should be applied after running `terraform apply` and wrapper_functions.sql
...
tool_resources:
  euno_instructions:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_INSTRUCTIONS_WRAPPER"
  ...
  euno_search_resources:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_SEARCH_RESOURCES_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_count_resources:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_COUNT_RESOURCES_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_fetch_single_resource:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_FETCH_SINGLE_RESOURCE_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_find_resource_by_name:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_FIND_RESOURCE_BY_NAME_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_find_resources_for_topic:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_FIND_RESOURCES_FOR_TOPIC_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_get_upstream_lineage:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_GET_UPSTREAM_LINEAGE_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_resource_impact_analysis:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_RESOURCE_IMPACT_ANALYSIS_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_documentation_search:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_DOCUMENTATION_SEARCH_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_documentation_get_full_document:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_DOCUMENTATION_GET_FULL_DOCUMENT_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  ...
  euno_documentation_get_surrounding_context:
    type: "function"
    identifier: "${DATABASE_NAME}.${SCHEMA_NAME}.EUNO_DOCUMENTATION_GET_SURROUNDING_CONTEXT_WRAPPER"
    execution_environment:
      type: "warehouse"
      warehouse: "${WAREHOUSE_NAME}"
  $$;
